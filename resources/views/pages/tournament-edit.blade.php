...
<div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="{{ route('tournament.update', $item->id ) }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="title">Tournament Kategori</label>
                            <select name="id_category" class="form-control">
                                <option value="{{ $item->id_category }}">--Pilih Kategori--</option>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ URL::to('/') }}/gambar-logo/{{ $item->logo }}" class="img-thumbnail" width="200">
                        <input type="hidden" name="hidden_image" value="{{ $item->logo }}">
                    </div>
